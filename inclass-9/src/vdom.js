    ...
    if (!oldNode) {
    	...
    	if (changed(newNode, oldNode)) {
            ...
            if (newNode.children < oldNode.children) {
            	Array.prototype.splice(parent.children, index, 1, createElement(newNode))
            } else {
                Array.prototype.forEach.call(newNode.children, function(child, idx) {
                    updateElement(parent.children[index], child, oldNode.children[idx], idx)
                })
            }
        }
    }
